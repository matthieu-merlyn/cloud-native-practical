package com.ezgroceries.shoppinglistnew.service;

import com.ezgroceries.shoppinglistnew.client.CocktailDBClient;
import com.ezgroceries.shoppinglistnew.client.CocktailDBResponse;
import com.ezgroceries.shoppinglistnew.client.CocktailDBResponse.Drink;
import com.ezgroceries.shoppinglistnew.entities.CocktailEntity;
import com.ezgroceries.shoppinglistnew.model.Cocktail;
import com.ezgroceries.shoppinglistnew.repository.CocktailRepository;
    ...
    private List<Cocktail> mergeCocktails(List<Drink> drinks) {
        ...
        Map<String, CocktailEntity> allEntityMap = drinks.stream().map(drink -> {
            ...
            if (cocktailEntity == null) {
                var idDrink = drink.getIdDrink();
                var strDrink = drink.getStrDrink();
                var getStrIngredients = drink.getStrIngredients();
